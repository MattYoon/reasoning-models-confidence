...
python -m eval.eval \
    ...
    --batch_size auto \
    --output_path logs/reasoning_ablations/no_cot/$OUTPUT_SUBDIR \
...
export DS_PATH=DKYoon/r1-triviaqa-epistemic
echo "Running dataset: $DS_PATH, Size: $DS_SIZE"
OUTPUT_SUBDIR=${DS_PATH#*/}
...
python -m eval.eval \
    ...
    --model_args pretrained=deepseek-ai/DeepSeek-R1-Distill-Qwen-32B,tensor_parallel_size=2,dtype="bfloat16",enforce_eager=True,gpu_memory_utilization=0.90,max_model_len=8192,data_parallel_size=1 \
    --batch_size auto \
    --output_path logs/reasoning_ablations/epistemic/$OUTPUT_SUBDIR \


export DS_PATH=DKYoon/r1-nonambigqa-epistemic
echo "Running dataset: $DS_PATH, Size: $DS_SIZE"
OUTPUT_SUBDIR=${DS_PATH#*/}
...
export DS_PATH=DKYoon/r1-triviaqa-non-linear
echo "Running dataset: $DS_PATH, Size: $DS_SIZE"
OUTPUT_SUBDIR=${DS_PATH#*/}
...
python -m eval.eval \
    ...
    --model_args pretrained=deepseek-ai/DeepSeek-R1-Distill-Qwen-32B,tensor_parallel_size=2,dtype="bfloat16",enforce_eager=True,gpu_memory_utilization=0.90,max_model_len=8192,data_parallel_size=1 \
    --batch_size auto \
    --output_path logs/reasoning_ablations/non-linear/$OUTPUT_SUBDIR \


export DS_PATH=DKYoon/r1-nonambigqa-non-linear
echo "Running dataset: $DS_PATH, Size: $DS_SIZE"
OUTPUT_SUBDIR=${DS_PATH#*/}
